...
const APP_CATALOG = [
  ...
  { id: 'betaalplein', naam: 'Laadplein', ico: '🔌', beschrijving: 'Bestaande aansluiting → laadplein: schat de laadsessies in, zie rendement + klantrapport.', url: '/apps/simulator.html?flow=betaalplein', gatedBy: 'simulator', video: 'https://cdn.jsdelivr.net/gh/JohanMMK/jacops-presentatie@main/Laadplein_JACOPS_EDrive.mp4' },   // 22-08: tegelnaam 'Betalend laadplein' → 'Laadplein' (Johan); id/flow ongewijzigd. 23-08: productvideo achter info-i (zoals thuisladen)
